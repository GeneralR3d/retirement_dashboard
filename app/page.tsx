    ...
    <div className="h-full overflow-y-auto flex flex-col">
      <div className="flex-1 flex items-start justify-center px-6 pt-24 pb-12">
        <div className="w-full max-w-4xl text-center space-y-5">
          <h1 className="text-4xl font-semibold tracking-tighter text-foreground sm:text-7xl">
          ...
          <p className="mx-auto max-w-2xl text-base leading-relaxed text-foreground/60 dark:text-foreground/50">
          ...
          <div className="pt-4">
            <Link
              href="/main"
              className="group inline-flex items-center gap-2 rounded-full bg-transparent px-8 py-3 text-base font-normal text-foreground/80 transition-colors hover:bg-emerald-600 hover:text-white hover:shadow-sm hover:shadow-emerald-600/25"
            >
              Try Retirement.sg
              <ArrowRight
